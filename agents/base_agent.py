            ...
            requests.append(
                {
                    ...
                    "user_facing_summary": action.get("planned_action", "Review this planned agent action before taking manual action."),
                    "technical_reason": "Generated by a simulation-only agent dry run from local records.",
            ...
            requests.append(
                {
                    ...
                    "is_test": False,
                    "severity": "needs_review",
                    "user_facing_summary": f"A generated draft for {draft.get('recipient_name') or draft.get('company') or 'this recipient'} needs human review.",
                    "technical_reason": "Message draft was created by a simulation-only agent run and remains not sent.",
